...
property_int (y, _("Height"), 10000000)
...
#define GEGL_OP_NAME     blinds
#define GEGL_OP_C_SOURCE blinds.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "categories",         "render",
    "title",              _("Blinds"),
    "reference-hash",     "b2f5f8513fag3b5141901b0cfcd17fbc",
    "position-dependent", "true",
    "description",        _("Blinds"),
    NULL);
}
