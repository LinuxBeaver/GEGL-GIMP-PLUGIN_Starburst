...
property_double (depth, _("Circle depth in percent"), 0.0)
...
property_boolean (bw, _("Map backwards"), TRUE)
...
property_boolean (activate, _("Activate"), TRUE)
  description    (_("Enable the mapping"))
...
#define GEGL_OP_NAME     zzspolar
#define GEGL_OP_C_SOURCE zzspolar.c
         ...
         gint                 level)
{
  ...
  if (!(o->activate)) {
    /* copy input to output in this case */
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",               "gegl:zzpolar-coordinates-for-starburst",
    "title",              _("z polar coordinates clone"),
    "categories",         "",
    "position-dependent", "true",
    "reference-hash",     "411692746705311bd29937d5d127f59b",
    "license",            "GPL3+",
    "description", _("clone of polar coordinates that only exist to power GEGL starburst"),
    NULL);
}
